...
const registerUser = async (req, res) => {
  let { email, password, confirmPassword, phoneNumber, username } = req.body;
  ...
  try {
    ...
    const link = `https://www.bazelink.co.ke/auto?email=${email}&code=${alphanumericCode}` 
...
const updateEmail = async (req, res) => {
  ...
  try {
    ...
    const link = `https://www.bazelink.co.ke/auto?email=${newEmail}&code=${user.verificationCode}`
...
const resendVerificationCode = async (req, res) => {
  ...
  try {
    ...
    const link =  `https://www.bazelink.co.ke/auto?email=${email}&code=${user.verificationCode}` 
...
const newrecoverPassword = async (req, res) => {
  try {
    ...
    const link =`https://www.bazelink.co.ke/reset-password` 
