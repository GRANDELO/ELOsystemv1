...
import '../../styles/sales.css'; // Ensure you have your styles set
import FilterControls from './FilterControls'; // Make sure you have this component
import FinancialChart from './FinancialChart'; // Make sure you have this component
import MonthlySalesTable from './MonthlySalesTable'; // Make sure you have this component
import SummaryCards from './SummaryCards'; // Make sure you have this component
import TransactionDetails from './TransactionDetails'; // Make sure you have this component
...
const FinancialSummary = () => {
  ...
  return (
    <div className="sal-container">
      ...
      {activeSection === 'summary' && <SummaryCards summary={summary} />}
      {activeSection === 'sales' && <MonthlySalesTable filteredSales={filteredSales} />}
      {activeSection === 'transactions' && <TransactionDetails summary={summary} />}
      {activeSection === 'chart' && <FinancialChart chartData={chartData} />}
