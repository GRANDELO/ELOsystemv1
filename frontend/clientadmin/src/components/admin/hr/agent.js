...
const Agent = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axiosInstance.get('/agent/users');
  ...
  const fetchActiveUsers = async () => {
    try {
      const response = await axiosInstance.get('/agent/active');
  ...
  const fetchDisabledUsers = async () => {
    try {
      const response = await axiosInstance.get('/agent/disabled');
  ...
  const fetchRegistrationGraph = async () => {
    try {
      const response = await axiosInstance.get('/agent/registration-graph');
  ...
  const disableUser = async (userId) => {
    try {
      await axiosInstance.patch(`/agent/disable/${userId}`);
      fetchUsers();
    } catch (error) {
  ...
  const undoDisableUser = async (userId) => {
    try {
      await axiosInstance.patch(`/agent/undo-disable/${userId}`);
      fetchUsers();
    } catch (error) {
