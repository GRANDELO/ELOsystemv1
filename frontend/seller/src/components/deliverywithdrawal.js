...
const Withdrawal = () => {
  ...
  useEffect(() => {
    const fetchWithdrawals = async () => {
      try {
        const response = await axios.get(`https://elosystemv1.onrender.com/api/withdraw/delivery/withdrawals/${username}`);
  ...
  const handleWithdraw = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://elosystemv1.onrender.com/api/withdraw/delivery', {
        username,
        Phonenumber,
